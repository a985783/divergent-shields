...
Use the repository Python scripts:
- `scripts/fetch_data.py`
- `scripts/fetch_data_upgrade.py`
...
- `scripts/verify_reproducibility.py`: Minimal artifact verification checks
...
3. Contact: qingsongcui9857@gmail.com for processed data availability
