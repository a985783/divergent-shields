...
We conduct a permutation test by treating each donor country as a "placebo" treated unit. The test yields a p-value of **0.20** (5 permutations), suggesting the effect is marginally significant. The limited number of donor countries constrains statistical power, but the effect size is economically meaningful.
...
**Poland Results**:
*   **Exchange Rate Shock on Core Inflation**: At horizon h=12, a 1% depreciation increases core inflation by **0.312 percentage points** (p<0.05). This effect is statistically significant and economically large.
...
- **Permutation Test**: Treating each donor country as a placebo-treated unit yields a p-value of **0.20** (5 permutations). While marginally significant, the limited donor pool constrains statistical power.
...
**Conclusion**: The structural shield (Spain) achieved disinflation with a modest fiscal transfer (<0.4% GDP), whereas the monetary shield (Poland) required a significant recessionary adjustment in the industrial sector.
